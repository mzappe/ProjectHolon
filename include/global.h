...
struct SaveBlock2
{
    ...
    /*0x14*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]
             ...
             u16 shinyRate:3; // Project Holon: player-chosen Shiny encounter rate, enum ShinyRateLevel (see shiny_rate.h)
             //u16 padding1:1;
             //u16 padding2;
    /*0x18*/ struct Pokedex pokedex;
    /*0x90*/ u32 lastSavePlayTimeSeconds; // Holon: successful save playtime + 1; zero means unknown. See HandleSavingData().
