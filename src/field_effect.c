...
// Holon prologue: the "Birch" intro sprite is reskinned as Steven (see GDDs/dev/prologue-plan.md, Step 0).
// steven.png is already 64x64 / 4bpp / 16-colour, same format as birch.png.
static const u32 sNewGameBirch_Gfx[] = INCGFX_U32("graphics/trainers/front_pics/steven.png", ".4bpp");
static const u32 sUnusedBirchBeauty[] = INCGFX_U32("graphics/birch_speech/unused_beauty.png", ".4bpp", "-num_tiles 822 -Wnum_tiles");
static const u16 sNewGameBirch_Pal[16] = INCGFX_U16("graphics/trainers/front_pics/steven.png", ".gbapal");
