---
title: "Pokémon Holon Legends — Delta Species Sprite Palette Swapping Guide"
doc-id: HL-ART-001
version: 1.0
status: Stable
category: Art
...
- [1. Before You Start — Understanding the Constraints](#1-before-you-start--understanding-the-constraints)
- [2. File Locations](#2-file-locations)
- [3. Workflow Steps](#3-workflow-steps)
  - [3.1 Open the Source Sprite in Indexed Mode](#31-open-the-source-sprite-in-indexed-mode)
  - [3.2 Load the Sprite's Palette](#32-load-the-sprites-palette)
  - [3.3 Read the Palette Before Touching Anything](#33-read-the-palette-before-touching-anything)
  - [3.4 Plan Your Delta Recolor](#34-plan-your-delta-recolor)
  - [3.5 Edit Palette Slots](#35-edit-palette-slots)
  - [3.6 Handle the Accent Color](#36-handle-the-accent-color)
  - [3.7 Never Touch These Slots](#37-never-touch-these-slots)
  - [3.8 Export Correctly](#38-export-correctly)
  - [3.9 Repeat for Back and Icon](#39-repeat-for-back-and-icon)
  - [3.10 Verify In-Game](#310-verify-in-game)
- [4. Quick Reference — Common Issues](#4-quick-reference--common-issues)
- [5. Minimum Viable Sprite Set Per Delta](#5-minimum-viable-sprite-set-per-delta)
...
## 1. Before You Start — Understanding the Constraints
...
### 3.1 Open the Source Sprite in Indexed Mode
...
### 3.3 Read the Palette Before Touching Anything
...
## 4. Quick Reference — Common Issues
...
## 5. Minimum Viable Sprite Set Per Delta
...
| pokeemerald-expansion sprite format | `graphics/pokemon/` directory conventions |
| DS-style sprite dimensions | 80×80 px front/back, 32×32 px icon (expansion standard) |
...
|---------|------|---------|
| 1.0 | 2026-03-22 | Reorganized from delta_sprite_palette_guide.md; added frontmatter, TOC, numbered sections, callouts, Sources, Changelog |

---

*Pokémon Holon Legends — Delta Species Sprite Palette Swapping Guide | HL-ART-001 v1.0 | Last updated 2026-03-22*
